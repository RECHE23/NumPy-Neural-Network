from .utils import *
from neural_network.modules.pooling2d import GlobalAvgPool2d
...
class TestMaxPool2dLayer(unittest.TestCase):
    ...
    def test_forward_backward(self):
        ...
        self.torch_layer = lambda x: torch.nn.AdaptiveAvgPool2d((1, 1))(x).squeeze()
        self.tensorflow_layer = tensorflow.keras.layers.GlobalAveragePooling2D()
        self.tensorflow_layer(to_tensorflow(self.input_data))  # Tensorflow layer needs a forward pass to initialize...
        self.custom_layer = GlobalAvgPool2d()
