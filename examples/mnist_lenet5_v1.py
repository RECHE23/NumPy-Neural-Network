...
net.add(Convolutional2DLayer(1, 20, 5, 1, 2))
net.add(ReLU())
net.add(MaxPooling2DLayer((2, 2), (2, 2)))
net.add(Convolutional2DLayer(20, 50, 5, 1, 2))
net.add(ReLU())
net.add(MaxPooling2DLayer((2, 2), (2, 2)))
net.add(ReshapeLayer((2450, )))
net.add(FullyConnectedLayer(2450, 500))
net.add(ReLU())
net.add(FullyConnectedLayer(500, 10))
