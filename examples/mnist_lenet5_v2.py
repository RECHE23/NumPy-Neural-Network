...
net.add(Convolutional2DLayer(1, 6, 5, 1, 2))
net.add(Tanh())
net.add(AveragePooling2DLayer((2, 2), (2, 2)))
net.add(Convolutional2DLayer(6, 16, 5, 1, 0))
net.add(Tanh())
net.add(AveragePooling2DLayer((2, 2), (2, 2)))
net.add(ReshapeLayer((400, )))
net.add(FullyConnectedLayer(400, 120))
net.add(Tanh())
net.add(FullyConnectedLayer(120, 84))
net.add(Tanh())
net.add(FullyConnectedLayer(84, 10))
